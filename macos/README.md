...
### Способ 1. Загрузка готового DMG-установщика (Рекомендуется)

Скачайте `Antigravity-Unlocker-macOS.dmg` из раздела [Releases](https://github.com/Fuheshka/Antigravity-Unlocker/releases/latest) и перетащите приложение в папку «Программы».

### Способ 2. Автоматическая сборка и установка в `/Applications`
